...
public class PostServiceImpl implements PostService {
    ...
    public PostDto createPost(PostDto postDto, Integer userId, Integer categoryId) {
        ...
        User user = this.userRepo.findById(userId).orElseThrow(()-> new ResorceNotFoundException("User", "User id", userId));
        Category category = this.categoryRepo.findById(categoryId).orElseThrow(()-> new ResorceNotFoundException("Category", "category id", categoryId));
    ...
    public List<PostDto> getPostsByCategory(Integer categoryId) {
        Category cat= this.categoryRepo.findById(categoryId).orElseThrow(() -> new ResorceNotFoundException("Category", "category id", categoryId));
